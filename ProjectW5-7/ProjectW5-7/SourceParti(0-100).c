...
int main(void) {
	char PN[101] [100];/*Paint Name*/
	int PM[101];	/*Paint Minutes Input*/
	char PQ[101] [100]; /*Paint Qualification*/
	int PNL;	/*Paint Name Length*/
	int PRH[101];	/*Paint Hours Reply*/
	int PRM[101];	/*Paint Minutes Reply*/
	int i = 0;		/*Loop Counter*/
	int NP;
	printf("---CPC Paint Inspection---\n\n"); /*Program Title*/
	printf("Number of paints (0-100: ");
	scanf("%i", &NP);								
	while (i != NP) {
